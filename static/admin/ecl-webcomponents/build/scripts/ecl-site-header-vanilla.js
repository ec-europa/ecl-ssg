var ECL = (function (exports) {
  ...
  */
  ...
  var SiteHeader = /*#__PURE__*/function () {
     ...
     */
    SiteHeader.autoInit = function autoInit(root, _temp) {
      var _ref = _temp === void 0 ? {} : _temp,
        _ref$SITE_HEADER_CORE = _ref.SITE_HEADER_CORE,
        defaultOptions = _ref$SITE_HEADER_CORE === void 0 ? {} : _ref$SITE_HEADER_CORE;
      var siteHeader = new SiteHeader(root, defaultOptions);
      siteHeader.init();
      root.ECLSiteHeader = siteHeader;
      return siteHeader;
    };
    function SiteHeader(element, _temp2) {
      var _ref2 = _temp2 === void 0 ? {} : _temp2,
        _ref2$containerSelect = _ref2.containerSelector,
        containerSelector = _ref2$containerSelect === void 0 ? '[data-ecl-site-header-top]' : _ref2$containerSelect,
        _ref2$languageLinkSel = _ref2.languageLinkSelector,
        languageLinkSelector = _ref2$languageLinkSel === void 0 ? '[data-ecl-language-selector]' : _ref2$languageLinkSel,
        _ref2$languageListOve = _ref2.languageListOverlaySelector,
        languageListOverlaySelector = _ref2$languageListOve === void 0 ? '[data-ecl-language-list-overlay]' : _ref2$languageListOve,
        _ref2$languageListEuS = _ref2.languageListEuSelector,
        languageListEuSelector = _ref2$languageListEuS === void 0 ? '[data-ecl-language-list-eu]' : _ref2$languageListEuS,
        _ref2$languageListNon = _ref2.languageListNonEuSelector,
        languageListNonEuSelector = _ref2$languageListNon === void 0 ? '[data-ecl-language-list-non-eu]' : _ref2$languageListNon,
        _ref2$closeOverlaySel = _ref2.closeOverlaySelector,
        closeOverlaySelector = _ref2$closeOverlaySel === void 0 ? '[data-ecl-language-list-close]' : _ref2$closeOverlaySel,
        _ref2$searchToggleSel = _ref2.searchToggleSelector,
        searchToggleSelector = _ref2$searchToggleSel === void 0 ? '[data-ecl-search-toggle]' : _ref2$searchToggleSel,
        _ref2$searchFormSelec = _ref2.searchFormSelector,
        searchFormSelector = _ref2$searchFormSelec === void 0 ? '[data-ecl-search-form]' : _ref2$searchFormSelec,
        _ref2$loginToggleSele = _ref2.loginToggleSelector,
        loginToggleSelector = _ref2$loginToggleSele === void 0 ? '[data-ecl-login-toggle]' : _ref2$loginToggleSele,
        _ref2$loginBoxSelecto = _ref2.loginBoxSelector,
        loginBoxSelector = _ref2$loginBoxSelecto === void 0 ? '[data-ecl-login-box]' : _ref2$loginBoxSelecto,
    ...
    _proto.init = function init() {
      ...
      if (this.attachKeyListener && this.languageLink) {
        this.languageLink.addEventListener('keydown', this.handleKeyboardLanguage);
      }
    ...
    _proto.destroy = function destroy() {
      ...
      if (this.attachKeyListener && this.languageLink) {
        this.languageLink.removeEventListener('keydown', this.handleKeyboardLanguage);
      }
      if (this.attachClickListener && this.close) {
     ...
     */;
    _proto.openOverlay = function openOverlay() {
      // Check number of items and adapt display
      var columnsEu = 1;
      var columnsNonEu = 1;
      if (this.languageListEu) {
        // Get all Eu languages
        var itemsEu = queryAll('.ecl-site-header__language-item', this.languageListEu);
        ...
        if (columnsEu > 1) {
          this.languageListEu.classList.add("ecl-site-header__language-category--" + columnsEu + "-col");
        }
      }
      if (this.languageListNonEu) {
        // Get all non-Eu languages
        var itemsNonEu = queryAll('.ecl-site-header__language-item', this.languageListNonEu);
        ...
        // Apply column display
        if (columnsNonEu > 1) {
          this.languageListNonEu.classList.add("ecl-site-header__language-category--" + columnsNonEu + "-col");
        }
      }
      ...
      this.languageListEu.parentNode.classList.remove('ecl-site-header__language-content--stack');
      var popoverRect = this.languageListOverlay.getBoundingClientRect();
      var containerRect = this.container.getBoundingClientRect();
      if (popoverRect.width > containerRect.width) {
        // Stack elements
        this.languageListEu.parentNode.classList.add('ecl-site-header__language-content--stack');

        // Adapt column display
        if (this.languageListNonEu) {
          this.languageListNonEu.classList.remove("ecl-site-header__language-category--" + columnsNonEu + "-col");
          this.languageListNonEu.classList.add("ecl-site-header__language-category--" + Math.max(columnsEu, columnsNonEu) + "-col");
        }
      }

      // Check available space
      this.languageListOverlay.classList.remove('ecl-site-header__language-container--push-right');
      this.languageListOverlay.classList.remove('ecl-site-header__language-container--full');
      ...
      if (popoverRect.right > screenWidth) {
        var linkRect = this.languageLink.getBoundingClientRect();

        // Push the popover to the right
        this.languageListOverlay.classList.add('ecl-site-header__language-container--push-right');
        this.languageListOverlay.style.setProperty('right', "-" + (containerRect.right - linkRect.right) + "px");

        // Adapt arrow position
        var arrowPosition = containerRect.right - linkRect.right + linkRect.width / 2;
        var arrowSize = '0.5rem';
        this.languageListOverlay.style.setProperty('--ecl-language-arrow-position', "calc(" + arrowPosition + "px - " + arrowSize + ")");
      }

      // Mobile popover (full width)
      if (popoverRect.left === 0) {
        var _linkRect = this.languageLink.getBoundingClientRect();
        ...
        // Adapt arrow position
        var _arrowPosition = popoverRect.right - _linkRect.right + _linkRect.width / 2;
        var _arrowSize = '0.5rem';
        this.languageListOverlay.style.setProperty('--ecl-language-arrow-position', "calc(" + _arrowPosition + "px - " + _arrowSize + ")");
      }
    }
     ...
     * @param {Event} e
     */;
    _proto.toggleOverlay = function toggleOverlay(e) {
     ...
     * @param {Event} e
     */;
    _proto.handleKeyboardLanguage = function handleKeyboardLanguage(e) {
     ...
     * @param {Event} e
     */;
    _proto.toggleSearch = function toggleSearch(e) {
      if (!this.searchForm) return;
      e.preventDefault();

      // Get current status
      var isExpanded = this.searchToggle.getAttribute('aria-expanded') === 'true';

      // Close other boxes
      if (this.loginToggle && this.loginToggle.getAttribute('aria-expanded') === 'true') {
        this.toggleLogin(e);
      }

      // Toggle the search form
      this.searchToggle.setAttribute('aria-expanded', isExpanded ? 'false' : 'true');
      if (!isExpanded) {
     ...
     * @param {Event} e
     */;
    _proto.toggleLogin = function toggleLogin(e) {
      if (!this.loginBox) return;
      e.preventDefault();

      // Get current status
      var isExpanded = this.loginToggle.getAttribute('aria-expanded') === 'true';

      // Close other boxes
      if (this.searchToggle && this.searchToggle.getAttribute('aria-expanded') === 'true') {
        this.toggleSearch(e);
      }

      // Toggle the login box
      this.loginToggle.setAttribute('aria-expanded', isExpanded ? 'false' : 'true');
      if (!isExpanded) {
    ...
    _proto.handleKeyboardGlobal = function handleKeyboardGlobal(e) {
      ...
      var listExpanded = this.languageLink.getAttribute('aria-expanded');
    ...
    _proto.handleClickGlobal = function handleClickGlobal(e) {
      ...
      if (listExpanded === 'true') {
        ...
        if (!this.languageListOverlay.contains(e.target) && !this.languageLink.contains(e.target)) {
          this.toggleOverlay(e);
        }
      }
    };
