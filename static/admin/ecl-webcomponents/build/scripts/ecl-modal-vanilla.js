var ECL = (function (exports) {
  ...
  */
  ...
  var Modal = /*#__PURE__*/function () {
     ...
     */
    Modal.autoInit = function autoInit(root, _temp) {
      var _ref = _temp === void 0 ? {} : _temp,
        _ref$MODAL = _ref.MODAL,
        defaultOptions = _ref$MODAL === void 0 ? {} : _ref$MODAL;
      var modal = new Modal(root, defaultOptions);
      modal.init();
      root.ECLModal = modal;
      return modal;
    };
    function Modal(element, _temp2) {
      var _ref2 = _temp2 === void 0 ? {} : _temp2,
        _ref2$toggleSelector = _ref2.toggleSelector,
        toggleSelector = _ref2$toggleSelector === void 0 ? '' : _ref2$toggleSelector,
        _ref2$closeSelector = _ref2.closeSelector,
        closeSelector = _ref2$closeSelector === void 0 ? '[data-ecl-modal-close]' : _ref2$closeSelector,
    ...
    _proto.init = function init() {
      ...
      if (this.toggleSelector === '') {
        this.toggleSelector = "#" + this.element.getAttribute('data-ecl-modal-toggle');
      }
      ...
      if (this.close && this.attachClickListener) {
        this.close.forEach(function (close) {
          close.addEventListener('click', _this.closeModal);
        });
      }
    ...
    _proto.destroy = function destroy() {
      ...
      if (this.close && this.attachClickListener) {
        this.close.forEach(function (close) {
          close.removeEventListener('click', _this2.closeModal);
        });
      }
