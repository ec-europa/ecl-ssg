...
const o = class {
  constructor(i) {
    ...
    this.titleAttr = undefined;
    this.external = false;
    this.ariaLabel = undefined;
    this.name = undefined;
  }
  getClass() {
    const e = [ `ecl-link`, `ecl-link--${this.variant}`, this.styleClass ];
    if (this.el.querySelector("ecl-icon")) {
      ...
      if (this.el.querySelector("ecl-icon").getAttribute("slot") === "icon-after") {
        ...
        e.push("ecl-link--icon-before");
      }
    }
    return e.join(" ");
  }
  componentDidRender() {
    const e = Object.keys(this.el.dataset);
    if (e) {
      e.forEach((e => {
        const i = this.el.firstElementChild;
        i.dataset[e] = "";
        delete this.el.dataset[e];
      }));
    }
    if (this.el.querySelector("ecl-icon")) {
  ...
  getAttrs() {
    ...
    if (this.titleAttr) {
      e["title"] = this.titleAttr;
    }
    if (this.ariaLabel) {
      e["aria-label"] = this.ariaLabel;
    }
    return e;
  }
  render() {
    return i("a", Object.assign({}, this.getAttrs()), i("slot", {
      name: "icon-before"
    }), i("slot", null), i("slot", {
      name: "icon-after"
...
export { o as ecl_link };
//# sourceMappingURL=p-76cbdd80.entry.js.map